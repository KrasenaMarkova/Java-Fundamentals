...
// where the value is formatted to the second digit after the decimal point and not add it to the total
// money. On the next few lines until you receive "End" you will be given products to purchase.
...
// "Purchased {product name}". After the "End" command, print the money that is left formatted to
// the second decimal point in the format "Change: {money left}".
...
public class VendingMachine07 {
    public static void main(String[] args) {
        ...
        System.out.printf("Change: %.2f", sumInCoins);
    }
}
