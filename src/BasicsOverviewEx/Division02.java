...
//You will be given an integer, and you have to print on the console whether that number is
...
// and you should print the division by 10. If the number is not divisible by any given number,
